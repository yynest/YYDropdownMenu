...
@interface TestViewController ()<dropdownDelegate> {
...
- (void)addDropdownMenu{
    ...
    DropdownMenu *dropdown = [[DropdownMenu alloc] initDropdownWithButtonTitles:titleArray andLeftListArray:leftArray andRightListArray:rightArray];
