...
- (UIButton *)makeButton:(NSString *) title andIndex:(int)index{
    ...
    if (index == 0) {
        ...
        _image = [UIImage imageNamed:@"nearbyhospital_downarrow_normal"];
        float padding = (width - (_image.size.width + [title sizeWithFont:[UIFont systemFontOfSize:17.0f]].width)) / 2;
        ...
        [button setImageEdgeInsets:UIEdgeInsetsMake(11, [title sizeWithFont:[UIFont systemFontOfSize:17.0f]].width + padding + 5, 11, 0)];
