...
@interface Test3ViewController ()<YYMenuDelegate> {
...
- (void)addDropdownMenu{
    ...
    leftArray = [[NSArray alloc] initWithObjects:Three_leftArray, nil];
    ...
    rightArray = [[NSArray alloc] initWithObjects: H_rightArray,nil];
